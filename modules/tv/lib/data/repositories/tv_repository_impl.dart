...
extension EntityMapper on WatchlistTable {
  static WatchlistTable fromTvEntity(TvDetail tv) => WatchlistTable(
        id: tv.id,
        title: tv.name,
...
class TvRepositoryImpl implements TvRepository {
  ...
  Future<Either<Failure, String>> saveWatchlist(TvDetail movie) async {
    try {
      final result = await localDataSource
          .insertWatchlist(EntityMapper.fromTvEntity(movie));
      return Right(result);
  ...
  Future<Either<Failure, String>> removeWatchlist(TvDetail movie) async {
    try {
      final result = await localDataSource
          .removeWatchlist(EntityMapper.fromTvEntity(movie));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    }
