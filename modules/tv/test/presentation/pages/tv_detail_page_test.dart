...
void main() {
  late MockTvDetailCubit mockNotifier;

  setUp(() {
    mockNotifier = MockTvDetailCubit();
  });
  ...
  testWidgets('Circullar progress should display when still loading',
    ...
    final expected = TvDetailState.initial().copyWith(
  ...
  testWidgets(
      'Circular progress should display when recommendation is still loading',
      (WidgetTester tester) async {
    final expected = TvDetailState.initial().copyWith(
