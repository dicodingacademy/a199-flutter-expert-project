...
void main() {
  ...
  group('Get TV Series Detail By Id', () {
    ...
    test('should return TV Series Detail Table when data is found', () async {
      // arrange
      when(mockDatabaseHelper.getItemByIdAndType(tId, ItemType.tvSeries))
    ...
    test('should return null when data is not found', () async {
      // arrange
      when(mockDatabaseHelper.getItemByIdAndType(tId, ItemType.tvSeries)).thenAnswer((_) async => null);
      // act
      final result = await dataSource.getTvSeriesById(tId);
      // assert
      expect(result, null);
  ...
  group('get watchlist TV Series', () {
    test('should return list of TvSeriesTable from database', () async {
      // arrange
      when(mockDatabaseHelper.getWatchlist(ItemType.tvSeries.toString()))
          .thenAnswer((_) async => [testTvSeriesMap]);
      // act
